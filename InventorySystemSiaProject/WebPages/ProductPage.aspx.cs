...
namespace InventorySystemSiaProject.WebPages
{
    ...
    public partial class ProductPage : System.Web.UI.Page
    {
                ...
                if (fuProductImage != null && fuProductImage.HasFile)
                {
                    try
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(uploadedUrl))
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine("🌥️ Cloudinary product image uploaded: " + uploadedUrl);
                        }
                    }
                    catch (Exception upEx)
                    {
                        System.Diagnostics.Debug.WriteLine("❌ Cloudinary product upload failed: " + upEx.Message);
                    }
                }
        ...
        protected async void btnSaveVariant_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(productId))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("🧪 ATTEMTING TO FIND MOST RECENT PRODUCT...");
        ...
        private void ClearVariantForm()
        {
            ...
            txtVariantImageUrl.Text = string.Empty;
        }
            ...
            try
            {
                ...
                var testVariants = new List<ProductVariant>
                {
                    new ProductVariant
                    {
                        ...
                        VariantImg = "/Content/images/sample-generic.png"
                    },
                    new ProductVariant
                    {
                        ProductId = productId,
