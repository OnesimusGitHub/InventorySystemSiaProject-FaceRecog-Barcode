        ...
        public async Task SeedBeautyProductsAsync()
        {
            try
            {
                ...
                var variants = new List<ProductVariant>
                {
                    ...
                    {
                        ProductId = productIds[6],
                        VariantName = "Matte Lipstick - Nude Rose",
                        Size = "3.5g",
                        Color = "Nude Rose",
                        SKU = "ML-NR-001",
                        Price = 18.99m,
                ...
                // Create some product-ingredient relationships
                var productIngredients = new List<ProductIngredient>
                {
                    ...
                    {
                        ProductId = productIds[0],
                        IngredientId = ingredientIds[0], // Hyaluronic Acid
                        QuantityRequired = 5.0m,
                        Unit = "ml"
                    },
                    // Vitamin C Cream ingredients
                    new ProductIngredient
                    {
                        ProductId = productIds[1],
                        IngredientId = ingredientIds[1], // Vitamin C
                        QuantityRequired = 2.0m,
                        Unit = "g"
                    },
                    new ProductIngredient
                    {
                        ProductId = productIds[1],
                        IngredientId = ingredientIds[3], // Niacinamide
                    ...
                    {
                        ProductId = productIds[2],
                        IngredientId = ingredientIds[2], // Retinol
                    ...
                    {
                        ProductId = productIds[2],
                        IngredientId = ingredientIds[6], // Peptides
                        QuantityRequired = 1.0m,
                        Unit = "g"
                    },
                    new ProductIngredient
                    {
                        ProductId = productIds[2],
                        IngredientId = ingredientIds[7], // Ceramides
                        QuantityRequired = 2.0m,
                        Unit = "g"
                    },
                    ...
                    {
                        ProductId = productIds[3],
                        IngredientId = ingredientIds[4], // Salicylic Acid
                        QuantityRequired = 1.0m,
                        Unit = "g"
                    },
                    new ProductIngredient
                    ...
                    // Exfoliating Toner ingredients
                    new ProductIngredient
                    {
                        ProductId = productIds[4],
                        IngredientId = ingredientIds[5], // Glycolic Acid
                        QuantityRequired = 2.0m,
                        Unit = "g"
                    }
                };
                ...
                {
                    await CreateProductIngredientAsync(productIngredient);
                }

                System.Diagnostics.Debug.WriteLine("Successfully seeded beauty products data!");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error seeding beauty products: {ex.Message}");
                throw;
            }
        }

        /// <summary>
        /// Seeds sample sales data
        /// </summary>
        public async Task SeedSalesDataAsync()
        {
            try
            {
                await Sale.SeedSalesDataAsync();
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error seeding sales data: {ex.Message}");
                throw;
            }
        }

        /// <summary>
        /// Seeds all data (products + sales)
        /// </summary>
        public async Task SeedAllDataAsync()
        {
            try
            {
                // First seed products (needed for sales)
                await SeedBeautyProductsAsync();
                
                // Then seed sales data
                await SeedSalesDataAsync();
                
                System.Diagnostics.Debug.WriteLine("Successfully seeded all data!");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error seeding all data: {ex.Message}");
                throw;
            }
        }
    }
